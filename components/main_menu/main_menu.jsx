                ...
                <Menu.Group>
                    ...
                    >
                        ...
                        <Menu.ItemToggleModalRedux
                            ...
                            modalId={ModalIdentifiers.INVITATION}
                            dialogType={InvitationModal}
                            text={formatMessage({id: 'navbar_dropdown.invitePeople', defaultMessage: 'Invite People 001'})}
                            extraText={formatMessage({id: 'navbar_dropdown.invitePeopleExtraText', defaultMessage: 'Add or invite people to the team 001'})}
                            icon={this.props.mobile && <i className='fa fa-user-plus'/>}
                        />
                    </TeamPermissionGate>
                </Menu.Group>
